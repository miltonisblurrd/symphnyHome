...
export default function AboutHeroLiquid() {
  return (
    <>
      <svg className={styles.aboutHeroFilterSvg} aria-hidden>
        <defs>
          <filter
            id="about-liquid-filter"
            x="-20%"
            y="-20%"
            width="140%"
            height="140%"
      ...
      <div className={styles.aboutHeroLiquid}>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/about-hero.png"
          alt=""
          decoding="async"
          style={{ filter: "url(#about-liquid-filter)" }}
        />
      </div>
    </>
  );
